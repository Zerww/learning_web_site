"""
Django settings for learning_web_site project.
"""
import os
...
# Database
_db_engine = config('DB_ENGINE', default='sqlite')  # 'mysql' or 'sqlite'
if _db_engine == 'mysql':
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',
            'NAME': config('DB_NAME', default='learning_web'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Learning Web Site API',
    'DESCRIPTION': '个人学习成果展示网站 API 文档',
    'VERSION': 'v1',
